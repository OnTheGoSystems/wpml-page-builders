 ...
 * @group media
 */
class Test_WPML_Page_Builders_Media_Translate_Helper extends OTGS_TestCase {
	...
	private function get_subject( $factory = null, $image_translate = null ) {
		...
		return new WPML_Page_Builders_Media_Translate_Helper( $factory, $image_translate );
	}
